...
> **All three are active works in progress** — research-grade, not production-ready. Each repo's README carries an honest-status section stating exactly what's validated and what isn't; the numbers below are measured where they're claimed, not a promise the whole system is finished.

**[lightr](https://github.com/HumanGuardrail/hugr-lightr)** *(work in progress)* — daemonless, CAS-native container runtime.
...
**[lightr-cri](https://github.com/HumanGuardrail/lightr-cri)** *(work in progress)* — stateless, crash-only Kubernetes CRI for lightr.
...
**[datarail](https://github.com/HumanGuardrail/HuGR_Datarail)** *(work in progress · single-node prototype)* — an end-to-end-sealed data rail; a Kafka-wire-compatible broker whose storage never sees plaintext.
